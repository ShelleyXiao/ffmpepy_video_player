...
#ifndef ANDROIDFFMPEGPLAYER_YUV_TEXTURE_FRAME_COPIER_H
#define ANDROIDFFMPEGPLAYER_YUV_TEXTURE_FRAME_COPIER_H
...
#endif //ANDROIDFFMPEGPLAYER_YUV_TEXTURE_FRAME_COPIER_H
