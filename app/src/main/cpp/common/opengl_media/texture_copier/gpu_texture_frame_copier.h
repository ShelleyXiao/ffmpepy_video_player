...
#ifndef ANDROIDFFMPEGPLAYER_GPU_TEXTURE_FRAME_COPIER_H
#define ANDROIDFFMPEGPLAYER_GPU_TEXTURE_FRAME_COPIER_H
...
#endif //ANDROIDFFMPEGPLAYER_GPU_TEXTURE_FRAME_COPIER_H
