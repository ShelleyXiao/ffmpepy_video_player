...
#ifndef ANDROIDFFMPEGPLAYER_VIDEO_PLAYER_CONTROLLER_H
#define ANDROIDFFMPEGPLAYER_VIDEO_PLAYER_CONTROLLER_H
...
#include "egl_core/egl_shared_context.h"
...
public:
    ...
    bool init(char *videoFileName, JavaVM *g_jvm, jobject obj,
              int *max_analyze_duration, int analyzeCnt, int probesize, bool fpsProbeSizeConfigured,
    ...
    void signalOutputFrameAvaiable();
...
#endif //ANDROIDFFMPEGPLAYER_VIDEO_PLAYER_CONTROLLER_H
