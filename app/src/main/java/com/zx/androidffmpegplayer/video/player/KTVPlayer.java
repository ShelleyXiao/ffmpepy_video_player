...
import com.zx.androidffmpegplayer.video.decoder.MediaCodecDecoderLifeCycle;
import com.zx.androidffmpegplayer.video.player.OnInitializedCallback.OnInitialStatus;
...
public class KTVPlayer extends MediaCodecDecoderLifeCycle {
    ...
    public void onInitializedFromNative(boolean initCode) {
        if (initializedCallback != null) {
            OnInitializedCallback.OnInitialStatus onInitialStatus = initCode ? OnInitialStatus.CONNECT_SUCESS : OnInitialStatus.CONNECT_FAILED;
