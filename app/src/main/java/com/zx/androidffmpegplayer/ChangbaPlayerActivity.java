...
import com.zx.androidffmpegplayer.video.player.KTVPlayer;
import com.zx.androidffmpegplayer.video.player.OnInitializedCallback;
...
public class ChangbaPlayerActivity extends Activity implements OnSeekBarChangeListener {
	...
	private KTVPlayer playerController;
	...
	private Callback previewCallback = new Callback() {
		...
		public void surfaceCreated(SurfaceHolder holder) {
			...
			if (isFirst) {
				playerController = new KTVPlayer() {
...
//				String path = "/mnt/sdcard/Movies/download/at.mp4";
				String path = "/mnt/sdcard/media/test.mpg";
//				String path = "/storage/emulated/0/media/test2.mp4";
